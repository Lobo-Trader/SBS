...
### Schritt 5 – P5 und Stop-Logik

- P5 muss P4 **nicht** zwingend unterbieten, wird aber bevorzugt
- Begründung: Je tiefer P5 unter P4, desto **näher am Stop** = kleineres Risiko
- Stop liegt immer **jenseits der Move Origin** (5min Move Origin als Grenze)
- In diesem Beispiel: **27 Punkte Stop** (NQ)
- Kein Warten auf ein bestimmtes Candlestick-Pattern – nur Sweep von P4 genügt
